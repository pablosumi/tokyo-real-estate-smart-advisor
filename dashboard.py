...
def main():
    ...
    st.markdown("Enter property details to estimate market value based on MLIT historical data.")

    # --- TABS FOR 20 FEATURES ---
    tab1, tab2, tab3 = st.tabs(["📍 Context & Usage", "🏗️ Building Specs", "📐 Land & Zoning"])
    ...
    with tab1:
        ...
        with col1:
            ...
            region = st.selectbox("Region", options=[None,
                                                     'Commercial Area',
                                                     'Residential Area',
                                                     'Industrial Area','Potential Residential Area'])
        with col2:
            purpose = st.selectbox("Purpose", options=[None,
                                                       'House',
                                                       'Office',
                                                       'Other',
                                                       'Shop',
            ...
            renovation = st.selectbox("Renovation", options=[None,
                                                             'Not yet',
                                                             'Done'])
    ...
    with tab3:
        ...
        with col2:
            ...
            coverage_ratio = st.slider("Coverage Ratio (%)", 0, 500, 5)
            floor_area_ratio = st.slider("Floor Area Ratio (%)", 0, 1300, 10)
    ...
    user_input = {
        ...
        'Renovation': None if renovation == "Unknown" else renovation
    }
